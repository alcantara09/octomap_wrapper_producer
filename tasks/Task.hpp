...
#ifndef OCTOMAP_WRAPPER_PRODUCER_TASK_TASK_HPP
#define OCTOMAP_WRAPPER_PRODUCER_TASK_TASK_HPP
 ...
 * The name of a TaskContext is primarily defined via:
 ...
 task('custom_task_name','octomap_wrapper_producer::Task')
 end
 \endverbatim
...
public:
	 ...
	 */
	Task(std::string const& name = "octomap_wrapper_producer::Task", TaskCore::TaskState initial_state = Stopped);
